...
import com.example.Tokkit_server.system_error_log.service.SystemErrorLogService;
...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException e,
        ...
        logSystemError(e, httpServletRequest);
    ...
    private void logSystemError(Exception e, HttpServletRequest request) {
        String traceId = Optional.ofNullable(MDC.get("traceId")).orElse("unknown");
        systemErrorLogService.logError(e, request, traceId);
    }
}
